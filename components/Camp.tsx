    ...
    >
      ...
      >
        <CampSite
          ...
          title="German Camping Site Nurnburg"
          subtitle="Nuernberg, Germany"
          peopleJoined="30+ Joined"
        />
        <CampSite
          backgroundImage="bg-bg-img-2"
          title="German Camping Site Cologne"
          subtitle="Cologne, Germany"
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        >
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            This will be the start of a great adventure in Germany. Feel free to
            explore new climbing locations and see what's going on. That's for
            those of you who are looking for a new adventure.
          </p>
          <Image
            src="/quote.svg"
            alt="camp-22"
